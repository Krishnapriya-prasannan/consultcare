  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <ul>
          <li className="mb-4">
            <a href="doctorpage/profile" className="hover:text-gray-200">Profile</a>
          </li>
          <li className="mb-4">
            <a href="doctorpage/patient" className="hover:text-gray-200">Patients</a>
          </li>
          <li className="mb-4">
            <a href="doctorpage/appointment_schedule" className="hover:text-gray-200">Appointments</a>
          </li>
          <li className="mb-4">
            <a href="doctorpage/leave" className="hover:text-gray-200">Leave</a>
          </li>
        </ul>
      </div>
    </div>
